...
res_PDF_LOC <- "https://github.com/ciannabp/ciannabp/raw/master/static/resume/bedford-petersen_resume.pdf"
res_HTML_LOC <- "https://ciannabp.rbind.io/resume/resume.html"
...
See full CV at [ciannabp.github.io/cv/](https://ciannabp.github.io/cv/) for a more complete list of positions and [publications](https://scholar.google.com/citations?user=74mOaFcAAAAJ&hl=en).
...
if(PDF_EXPORT){
  ...
  glue("[<i class='fas fa-download'></i> Download a PDF of this resume]({res_PDF_LOC})")
}
```
